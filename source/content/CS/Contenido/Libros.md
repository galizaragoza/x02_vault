...
Guía detallada, con mucha información útil y muchos pro-tips que no encontrarás en muchos otros sitios, sobre todos los pasos de una auditoría (con contenido para auditorías white y black box), desde el reconocimiento hasta la redacción del informe.
Se llega a hacer bastante tedioso, no recomendaría su lectura.
...
Breve, fácil de leer y supone una buena introducción para principiantes que quieren iniciarse en el uso de Kali, a la hora de leerlo aprendí un par de cosas pero no recomendaría su lectura a un usuario medianamente experimentado o que ya haya leído How Linux Works.


# Programación
## The C programming Language (ANSI edition)
Denso, difícil de leer sin base, interesante, bien escrito aunque muy viejo, pero puede hacerse intragable en ciertos puntos, recomendaría leerlo por encima si a uno le interesa C o quiere ganar una base sólida con la que aprender otros lenguajes mas abstractos.