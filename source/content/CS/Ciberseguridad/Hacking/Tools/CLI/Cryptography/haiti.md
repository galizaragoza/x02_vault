Detecta el formato de un hash $X$, ideal para combinar con [[JohnTheRipper]] o [[hashcat]] para conocer el tipo de hash con el que se está trabajando para poder crackearlo.
