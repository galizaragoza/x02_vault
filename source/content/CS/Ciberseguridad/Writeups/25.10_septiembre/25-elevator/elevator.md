...
![[CS/Ciberseguridad/Writeups/25.10_septiembre/25-elevator/imgs/1.png]]
...
![[CS/Ciberseguridad/Writeups/25.10_septiembre/25-elevator/imgs/2.png]]
...
![[CS/Ciberseguridad/Writeups/25.10_septiembre/25-elevator/imgs/3.png]]
...
![[CS/Ciberseguridad/Writeups/25.10_septiembre/25-elevator/imgs/4.png]]

Repito el proceso con el usuario `daphne` para pivotar a `vilma`.

![[CS/Ciberseguridad/Writeups/25.10_septiembre/25-elevator/imgs/5.png]]

Y habiendo pivotado a `vilma`, repito el proceso de nuevo por `shaggy`, `fred`, y `scooby`.

![[CS/Ciberseguridad/Writeups/25.10_septiembre/25-elevator/imgs/6.png]]

Por último, y siguiendo una vez más el mismo proceso, llego a `root`.

![[CS/Ciberseguridad/Writeups/25.10_septiembre/25-elevator/imgs/7.png]]