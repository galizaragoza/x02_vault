...
| `--mask`  | Los ataques de máscara permiten definir patrones específicos de generación de contraseñas | hashcat -m 0 -a 3 --mask ?l?l?l?l?d?d?d?d hashes.txt                              |
| `--force` | Aplica distintos métodos con los que forzar el hardware para mejorar el rendimiento       | hashcat -m 0 --force -a 0 hashes.txt wordlist.txt                                 |
...
| ---------------- | ------------------ | --------------------------------------------------------------------- |
| Wordlist         | PPP                | `hashcat -a 0 -m 400 example400.hash example.dict`                    |
| Wordlist + Rules | MD5                | `hashcat -a 0 -m 0 example0.hash example.dict -r rules/best64.rule`   |
| Brute-Force      | MD5                | `hashcat -a 3 -m 0 example0.hash ?a?a?a?a?a?a`                        |
| Combinator       | MD5                | `hashcat -a 1 -m 0 example0.hash example.dict example.dict`           |
| Association      | $1$[[#Hash Modes]] | `hashcat -a 9 -m 500 example500.hash 1word.dict -r rules/best64.rule` |
# Hash Modes
```
      # | Name                                                       | Category
  ======+============================================================+======================================
  ...
  19210 | QNX 7 /etc/shadow (SHA512) F                               | Operating System
