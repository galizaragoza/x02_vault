...
```
  ...
  - La guía debe contener **todas** las opciones que la h
  - El formato de la guía debe ser apto para markdown, sela función de las opciones (e.g Formateo de output,

  - En caso de que la herramienta tenga distintas subherramientas (e.g. docker run, docker exec, docker ps), cada subherramienta debe ser
  como mínimo una categoría
  - El inicio de la guía ha de contener una explicación breve (3-4 frases) del propósito general de la herramienta
