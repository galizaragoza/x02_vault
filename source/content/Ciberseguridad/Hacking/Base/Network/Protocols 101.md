...
![[web-socket.png|384x300]]

# TCP / UDP
### TCP
Transmission Control Protocol es un protocolo orientado a la conexión, ampliamente usado en muchos otros protocolos y clave para la comunicación íntegra de dos o más equipos. TCP establece una conexión, uno de los ordenadores envía un mensaje SYN (syncronize), el otro contesta con un mensaje SYN-ACK(syncronize-acknowledge), por último, el ordenador que inició la conexión envía ACK y se inicia una conexión sobre la cual se transfiere la info. Esto se llama *three way handshake*.
